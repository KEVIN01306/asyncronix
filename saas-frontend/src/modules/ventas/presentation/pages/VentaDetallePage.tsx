...
import { ArrowBack as ArrowBackIcon, ShoppingBag, Receipt, Person, CalendarToday, CreditCard } from '@mui/icons-material';
...
import { FacturaVentaDocument } from '../components/FacturaVentaDocument';
...
export default function VentaDetallePage() {
    ...
    return (
        <Box py={4} px={{ xs: 2, md: 4 }} maxWidth="1300px" margin="auto">
            ...
            {/* Documento FEL Facturación */}
            {venta.factura && (
                <FacturaVentaDocument factura={venta.factura} />
            )}
                            ...
                            <Stack spacing={2.5}>
                                ...
                                {venta.estado === 'ANULADA' && venta.motivo_anulacion && (
                                    <>
                                        <Divider />
                                        <Box>
                                            <Typography variant="caption" color="error" display="block">Motivo de Anulación</Typography>
                                            <Typography variant="body2" sx={{ mt: 0.5, fontStyle: 'italic', color: 'error.main', bgcolor: 'error.lighter', p: 1.5, borderRadius: 1 }}>
