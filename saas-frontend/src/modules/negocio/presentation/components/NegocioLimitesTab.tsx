...
const getProgressBarColor = (porcentaje: number | null, theme: Theme) => {
    ...
    if (porcentaje <= 94) return '#ff5722';
        ...
        <Box>
            <Box mb={3}>
                ...
                <Typography variant="body2" color="text.secondary" mt={0.5}>
                    Monitorea el uso actual de las capacidades de tu plan activo.
                </Typography>
            </Box>
            ...
            <CustomTabPanel value={tabValue} index={0}>
                <Card>
                    <CardContent sx={{ p: { xs: 2, sm: 4 }, '&:last-child': { pb: { xs: 2, sm: 4 } } }}>
                        <Stack spacing={3}>
                            {limites.generales?.map((item: NegocioLimiteItem, index: number) => {
                                ...
                                return (
                                    <Box key={nombre}>
                                        ...
                                        {index < limites.generales.length - 1 && (
            ...
            <CustomTabPanel value={tabValue} index={1}>
                <MediaTab storage={limites.storage} />
            </CustomTabPanel>
        </Box>
    );
};
