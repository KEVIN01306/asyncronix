...
import { ESTADO_SERVICIO, METODO_PAGO } from '../../domain/servicio.constants';
...
const ServicioSalidaPage = () => {
    ...
    const isSalidaState = servicio?.estado === ESTADO_SERVICIO.LISTO_ENTREGA;
        ...
        <Box p={{ sm: 2, md: 4 }} maxWidth="1000px" margin="0 auto">
            ...
            <Box component={Paper} p={3}>
                ...
                <Box mt={3} p={3} sx={{ backgroundColor: '#f9fafb', borderRadius: 2 }}>
                    ...
                    {servicio.estado !== ESTADO_SERVICIO.LISTO_ENTREGA && (
