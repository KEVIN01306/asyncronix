...
const ServiceGeneralInfo= ({ servicio, onEdit, onMechanicUpdated }: Props) => {
    ...
    const canAssignMechanic = servicio.estado === ESTADO_SERVICIO_VEHICULO.RECEPCION;
    ...
    const canUpdateExternalClient = servicio.estado === ESTADO_SERVICIO_VEHICULO.RECEPCION;

    const handleSuccess = (s: ServicioVehiculo) => {
        // bubble up
