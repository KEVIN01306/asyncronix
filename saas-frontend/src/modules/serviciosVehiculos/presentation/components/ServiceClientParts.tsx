...
import type { ServicioRepuestoCliente, ServicioVehiculo } from '../../domain/interfaces/servicio.interface';
...
const ServiceClientParts = ({ servicio, onUpdate }: Props) => {
    ...
    const canEdit = servicio.estado === ESTADO_SERVICIO_VEHICULO.RECEPCION;
