...
import { BuscarClientePorDocumentoUseCase } from "./application/buscar-cliente-por-documento.usecase.js";
...
const buscarClientePorDocumentoUseCase = new BuscarClientePorDocumentoUseCase(clienteRepository);
