...
export const registrarServicioUseCase = new RegistrarServicioUseCase(repository);
...
export const crearServicioRepuestoUseCase = new CrearServicioRepuestoUseCase(repository, loteRepository, varianteRepository);
