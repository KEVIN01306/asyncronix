...
const eliminarProductoUseCase = new EliminarProductoUseCase(productoRepository, eliminarMediaUseCase);
const subirImagenProductoUseCase = new SubirImagenProductoUseCase(productoRepository, crearMediaUseCase);
const listarImagenesProductoUseCase = new ListarImagenesProductoUseCase(productoRepository);
const actualizarArchivoImagenProductoUseCase = new ActualizarArchivoImagenProductoUseCase(productoRepository, reemplazarMediaUseCase);
...
const eliminarImagenProductoUseCase = new EliminarImagenProductoUseCase(productoRepository, eliminarMediaUseCase);
