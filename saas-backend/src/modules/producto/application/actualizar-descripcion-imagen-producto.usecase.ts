...
export class ActualizarDescripcionImagenProductoUseCase {
    constructor(private readonly repository: ProductoRepository) { }

    async execute(imagen_id: string, descripcion: string | null, negocio_id: string): Promise<ImagenProducto> {
        ...
        return this.repository.actualizarDescripcionImagen(imagen_id, descripcion, negocio_id);
    }
}
