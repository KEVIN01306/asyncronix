...
interface ObtenerPerfilRespuesta extends Pick<UsuarioAutentificacion, "id" | "nombre"  | "apellido" | "email" | "telefono" | "avatar_url" | "roles"  | "negocio_id" | "permisos" | "negocio" | "sucursal_id"> { }
