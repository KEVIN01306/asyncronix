...
import type { VentaSimple, VentaObtenerDetalle, VentaCrear, VentaActualizar } from "./venta.entity.js";
...
export interface VentaRepository {
    ...
    anular(id: string, negocio_id: string, sucursal_id: string): Promise<VentaSimple>;
